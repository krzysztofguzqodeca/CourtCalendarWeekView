...
class DefaultEvent: JZBaseEvent {
    ...
    init(id: String, title: String, startDate: Date, endDate: Date, location: String, section: Int) {
    ...
    override func copy(with zone: NSZone?) -> Any {
        return DefaultEvent(id: id, title: title, startDate: startDate, endDate: endDate, location: location, section: section)
    }
}
