...
//                              currentSectionZ: zIndexForElementKind(JZSupplementaryViewKinds.eventCell))
    ...
    func layoutHorizontalGridLinesAttributes(calendarStartX: CGFloat, calendarStartY: CGFloat) {
        ...
        for hour in 0...24 {
            ...
            let horizontalGridlineWidth = fmax(calendarGridWidth, collectionView!.frame.width)
    ...
    override open var collectionViewContentSize: CGSize {
        return CGSize(width: rowHeaderWidth + 161 * CGFloat(collectionView!.numberOfSections),
